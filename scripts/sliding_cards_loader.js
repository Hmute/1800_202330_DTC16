...
//     let cardTemplate = document.getElementById("swipeCardTemplate"); // Retrieve the HTML element with the ID "hikeCardTemplate" and store it in the cardTemplate variable. 
    ...
    firebase.auth().onAuthStateChanged(user => {
        if (user) {
            ...
            currentUser.get().then(userDoc => {
                ...
                console.log(userName); //just printing  in the database 
